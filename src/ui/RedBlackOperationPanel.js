class RedBlackOperationPanel {
    constructor(module) {
        this.module = module;
        this.inputValue = document.getElementById('rbtInputValue');

        document.getElementById('btnRBTInsert').addEventListener('click', () => this._handleInsert());
        document.getElementById('btnRBTContains').addEventListener('click', () => this._handleContains());
        document.getElementById('btnRBTClear').addEventListener('click', () => this._handleClear());
    ...
    _renderScenarioButtons() {
        ...
        this._renderScenarioButtonsInto('RBTControls', scenarios, 'controls-group');
    ...
    _handleInsert() {
        ...
        if (value === null) {
            this.module.appManager.getGlobals().consolePanel.log('Informe um inteiro para Insert na Red-Black.');
            return;
        }
    ...
    _handleContains() {
        const value = this._parseValue();
        if (value === null) {
            this.module.appManager.getGlobals().consolePanel.log('Informe um inteiro para Contains na Red-Black.');
            return;
        }
